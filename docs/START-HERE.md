...
As of 2026-08-06 the *source* client is `EggFrecklesEF10:jbfly` — user-visible
name **"Egg Freckles"**, title "Egg Freckles 1.0-ef10", package version 22, and
