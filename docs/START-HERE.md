...
As of 2026-08-06 the *source* client is `EggFrecklesEF11:jbfly` — user-visible
name **"Egg Freckles"**, title "Egg Freckles 1.0-ef11", package version 23, and
